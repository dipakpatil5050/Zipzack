...
export const mockReels: ReelData[] = [
  {
    id: 'reel1',
    user: mockUsers[0],
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-young-woman-waking-up-in-the-morning-42696-large.mp4',
  ...
  },
  {
    id: 'reel5',
    user: mockUsers[4],
    videoUrl: 'https://assets.mixkit.co/videos/preview/mixkit-cooking-with-a-pan-in-a-well-lit-kitchen-5173-large.mp4',
    posterUrl: 'https://assets.mixkit.co/videos/preview/mixkit-cooking-with-a-pan-in-a-well-lit-kitchen-5173-large.mp4',
